                ...
                onTap: () {
                  setState(() {
                    if (!noteData.feedDetailCheckList[index] == true) {
                      Provider.of<NoteData>(context, listen: false).addSet.add(widget.postList[index]);
                    } else {
                      Provider.of<NoteData>(context, listen: false).addSet.remove(widget.postList[index]);
                    }
                    widget.checkedCountChange(!noteData.feedDetailCheckList[index]);
                    noteData.feedDetailCheckList[index] = !noteData.feedDetailCheckList[index];
                  });
                },
                child: Container(
